...
Building the industry's first open-source benchmark datasets for investment research. Unlike traditional vendors who limit trials to institutions, we believe in open access. Free access to all datasets with a brief delay; [subscribers](https://sov.ai) receive real-time data.
...
| 🧮 | [sovai/risk_indicators](https://huggingface.co/datasets/sovai/risk_indicators) | Risk indicators data from corporate events. | [Documentation](https://docs.sov.ai/realtime-datasets/equity-datasets/risk-indicators) | $270 |
